package CGI::Office::Contacts::Donations::Controller::Donations;

use base 'CGI::Office::Contacts::Donations::Controller';
use strict;
use warnings;

use CGI::Office::Contacts::Donations::Util::Validator;
...
sub add
{
	...
	my($input)       = CGI::Office::Contacts::Donations::Util::Validator -> new
	(
